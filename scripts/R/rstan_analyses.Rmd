...
With $\alpha$ being a general intercept term, $\eta$s as the ROI- and subject-wise deviations from the general intercept, and $\tau$s as the scaling factor for the deviations.
